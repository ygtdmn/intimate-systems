...
contract DeploySculptures is Script {
    function run() public returns (Mod data, Essay essay, IntimateSystems show, WebRenderer renderer) {
        ...
        sculptures[0] = Sculpture(0x00000063266aAAeDD489e4956153855626E44061);

        SculptureERC721[] memory sculptureERC721s = new SculptureERC721[](1);
        ...
        sculptureERC721s[0] = SculptureERC721(address(0x00000063266aAAeDD489e4956153855626E44061), 0);
        ...
        show = new IntimateSystems(sculptures, sculptureERC721s, WebRenderer(address(0)), Mod(address(data)));
