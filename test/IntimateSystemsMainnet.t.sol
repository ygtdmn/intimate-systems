...
contract IntimateSystemsMainnetTest is Test {
    function testRenderMainnetToFile() public {
        ...
        uint256 sepoliaFork = vm.createSelectFork({ urlOrAlias: "sepolia" });
        Essay essay = Essay(0xd5A0C91b0c3B990eD85a752C4f7025fD8a65f3aD);
        uint256 localhostFork = vm.createSelectFork({ urlOrAlias: "localhost" });

        Mod data = new Mod();

        // Set essay title and content (read from auto-generated file)
        // essay.setTitle("{title}");
        // string memory essayHtml = vm.readFile("essay/essay-autogenerated.html");
        // essay.setTextPt1(essayHtml);
        ...
        // Switch to Sepolia fork to access Essay's SSTORE2 data
